...
# opt.underwater_path -- 'data/underwater5000'
UW_test_loader = DataLoader(dataset=UWS_Dataset_Retinex_test(opt.underwater_path,
    train=False,size=opt.test_size,dcp=False),batch_size=1,shuffle=False,num_workers=0)
# pdb.set_trace()
...
g1ckpt = opt.model_path #  'model_path/UWNR.pk'
ckpt = torch.load(g1ckpt, map_location=torch.device('cpu'))
...
torch.save(new_state, "/tmp/image_water_style.pth")
